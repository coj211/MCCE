...
void Particle::render( Tesselator& t, float a, float xa, float ya, float za, float xa2, float za2, int texRows )
{
	float u0 = (tex % 16) / 16.0f;
	float u1 = u0 + 0.999f / 16.0f;
	float v0 = (tex / 16) / (float)texRows;
	float v1 = v0 + 0.999f / (float)texRows;
	float r = 0.1f * size;
