...
void ChestScreen::handleRenderPane(Touch::InventoryPane* a2, Tesselator& a3, int32_t a4, int32_t a5, float a6) {
	if(a2) {
		...
		a2->render(a4, a5, a6);
		this->field_180->draw(a3, (float)(a2->field_228.x - 1), (float)(a2->field_228.y - 1));
	}
}
void ChestScreen::setupPane() {
	...
	height = v26.height;
	this->field_140.x = v26.x;
	this->field_140.y = minY;
...
void ChestScreen::render(int32_t a2, int32_t a3, float a4) {
	...
	for(int32_t v9 = 0; v9 < this->field_190.size(); ++v9) {
		...
		if(v12 <= 0.3) {
			ItemRenderer::renderGuiItemNew(this->minecraft->textures, &v11->field_0, 0, (float)(v11->field_20 + (float)((float)(v11->field_28 - v11->field_20) * (float)((float)(v12 / 0.3) * (float)(v12 / 0.3)))) + 7.0, (float)(v11->field_24 + (float)((float)(v11->field_2C - v11->field_24) * (float)((float)(v12 / 0.3) * (float)(v12 / 0.3)))) + 8.0, 1.0, 1.0, 1.0);
			v16.push_back(*v11);
		} else {
...
void ChestScreen::setupPositions() {
	...
	this->field_104.x = width / 2;
	this->field_60.height = 19;
	this->field_60.width = 19;
	this->field_60.x = width - 19;
