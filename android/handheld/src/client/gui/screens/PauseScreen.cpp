...
void PauseScreen::init() {
	if (minecraft->useTouchscreen()) {
		...
		bQuitAndSaveLocally = new Touch::TButton(3, I18n::get("pause.quitAndCopy"));
...
//		bThirdPerson = new Touch::TButton(5, "Toggle 3:rd person view");
		...
		bQuitAndSaveLocally = new Button(3, I18n::get("pause.quitAndCopy"));
...
void PauseScreen::render(int xm, int ym, float a) {
	...
	drawCenteredString(font, I18n::get("pause.title"), width / 2, 24, 0xffffff);
