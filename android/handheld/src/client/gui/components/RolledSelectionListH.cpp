...
void RolledSelectionListH::setRenderSelection(bool a2) {
...
void RolledSelectionListH::setRenderHeader(bool a2, int32_t a3) {
	if(!a2) a3 = 0;
	this->field_48 = a2;
	this->field_44 = a3;
}

void RolledSelectionListH::setComponentSelected(bool a2) {
...
//void RolledSelectionListH::selectItem(int32_t, bool) = 0;
//bool RolledSelectionListH::isSelectedItem(int32_t) = 0;
