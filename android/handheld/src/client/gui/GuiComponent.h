...
public:
	...
	// 0.8.1 GUI 移植：边框矩形（thickness 版 + 四色版）
	void drawRect(int x0, int y0, int x1, int y1, int color, int thickness);
	void drawRect(int x0, int y0, int x1, int y1, int colorTop, int colorBottom, int colorLeft, int colorRight, int thickness);
