...
void StartMenuScreen::render(int32_t a2, int32_t a3, float a4) {
  ...
  this->drawString(this->font, this->gameVersion, this->field_150, 62,
                   0xFFCCCCCC);
  this->drawString(this->font, this->mojangABMaybe, this->field_148,
...
void StartMenuScreen::init() {
  ...
  this->mojangABMaybe =
      "\xFFMojang AB, ModifiedEight New Additions 1.6.4.1 by eqozqq";
...
bool_t StartMenuScreen::isInGameScreen() { return 0; }
