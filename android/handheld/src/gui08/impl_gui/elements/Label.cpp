...
void Label::render(Minecraft* mc, int32_t x, int32_t y) {
	...
	mc->font->drawWordWrap(this->text, (float)(this->widthBase + this->x), (float)(this->y + this->heightBase), (float)((float)this->width - (float)this->widthBase) + 1.0, this->field_2C, this->field_39, this->field_3A);
}
