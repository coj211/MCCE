...
void WorldSelectionList::selectItem(int32_t a2, bool a3) {
	int32_t v3; // r3
...
bool WorldSelectionList::isSelectedItem(int32_t a2) {
...
float WorldSelectionList::getPos(float a2) {
	...
	if(this->field_C0 != 1) {
		// 0.8.1 原版 bug（无限递归→栈溢出闪退），改为调用基类（同 Touch 版）
		return RolledSelectionListH::getPos(a2);
	}
	v4 = this->field_5C;
	v5 = this->field_60;
	v6 = this->field_64;
...
void WorldSelectionList::renderItem(int32_t a2, int32_t a3, int32_t a4, int32_t a5, Tesselator& a6) {
	...
	this->minecraft->textures->loadAndBindTexture(this->field_8C[a2]);
	...
	v16 = v9 + 32;
	v17 = (float)v15;
	a6.vertexUV(v17, v14, this->blitOffset, 0.0, 0.0);
	a6.vertexUV(v17, v14 + 48.0, this->blitOffset, 0.0, 1.0);
	a6.vertexUV((float)v16, v14 + 48.0, this->blitOffset, 1.0, 1.0);
	a6.vertexUV((float)v16, v14, this->blitOffset, 1.0, 0.0);
	a6.draw();
}
